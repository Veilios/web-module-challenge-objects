...
console.log(createMenuItem("Chimichangas", "14.99", "Lunch"));
...
//reviews.push({name: "Alan", rating: 5, feedback: "Totally recommend for everyone. If my friends invite me, it's always a bet!"});
...
function getLastReview(reviews) {
    let last = reviews[reviews.length - 1];
    console.log(`${last.name} gave the restaurant a ${last.rating} star review and their feedback was: ${last.feedback}`)
  } 
